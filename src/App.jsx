      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/services/psychic-readings"
              element={<PsychicReadings />}
            />
            ...
            <Route
              path="/services/spiritual-remedies"
              element={<SpiritualRemedies />}
            />
            ...
            <Route
              ...
              element={<CorporateServicesOverview />}
            />
            <Route
              path="/corporate-services/mental-health"
              element={<MentalHealth />}
            />
            <Route
              path="/corporate-services/wellness-burnout"
              element={<WellnessBurnout />}
            />
            <Route
              path="/corporate-services/therapy-counseling"
              element={<TherapyCounseling />}
            />
            <Route
              path="/corporate-services/stress-management"
              element={<StressManagement />}
            />
            <Route
              path="/corporate-services/emotional-intelligence"
              element={<EmotionalIntelligence />}
            />
            <Route
              path="/corporate-services/leadership-mindfulness"
              element={<LeadershipMindfulness />}
            />
            <Route
              path="/corporate-services/holistic-wellness"
              element={<HolisticWellness />}
            />
