...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="relative py-20 lg:py-32 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 gradient-cosmic opacity-95" />
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-foreground mb-1">Phone / WhatsApp</h4>
                    <p className="text-primary-foreground/70">+91 93402 16182</p>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/70 break-all">ashrayspiritualsoul@gmail.com</p>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-foreground mb-1">Location</h4>
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <Input
                        ...
                        required
                        className="bg-white/5 border-white/20 text-primary-foreground placeholder:text-primary-foreground/40 focus:border-secondary"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        required
                        rows={5}
                        className="bg-white/5 border-white/20 text-primary-foreground placeholder:text-primary-foreground/40 focus:border-secondary resize-none"
                      />
                    </div>
