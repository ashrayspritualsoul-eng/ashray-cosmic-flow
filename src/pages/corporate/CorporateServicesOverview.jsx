...
const corporateServices = [
  ...
  },
  {
    ...
    description:
      "Interactive workshops teaching practical stress management techniques.",
  ...
  },
  {
    ...
    description:
      "Build emotional intelligence and resilience across your organization.",
  ...
  },
  {
    ...
    description:
      "Complementary wellness services including energy healing and spiritual guidance.",
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive corporate wellness programs designed to enhance
              employee wellbeing, boost productivity, and create a thriving
            ...
            {corporateServices.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${service.color} p-3 mb-4 group-hover:scale-110 transition-transform`}
                    >
          ...
          >
            <div className="bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 rounded-2xl p-12">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Schedule a consultation to discuss how our corporate wellness
