...
import { Sparkles, Heart, Zap, Shield, Sun, Wind, CheckCircle2, ArrowRight, Star, Brain, TrendingUp } from "lucide-react";
...
const ReikiHealing = () => {
  ...
  const offerings = [
    {
      ...
      description: "Classic hands-on or distance Reiki healing focusing on balancing your energy system and promoting deep relaxation.",
      features: [
    ...
    },
    {
      ...
      description: "Receive powerful Reiki energy healing from anywhere in the world through quantum connection and intention.",
      features: [
    ...
    },
    {
      ...
      description: "Targeted healing for specific chakras that are blocked, overactive, or imbalanced, restoring optimal energy flow.",
      features: [
        "Individual chakra assessment",
        "Targeted energy work",
        "Crystal enhancement",
    ...
    },
    {
      ...
      description: "Specialized session addressing emotional pain, trauma release, and restoring inner peace and emotional balance.",
      features: [
    ...
    },
    {
      ...
      description: "Reiki energy directed toward areas of physical discomfort to support healing and reduce pain naturally.",
      features: [
        "Localized energy focus",
    ...
    },
    {
      ...
      description: "Learn to practice Reiki yourself through traditional attunement and comprehensive training in energy healing.",
      features: [
        "Level 1, 2, or Master training",
  ...
  const whyItMatters = [
    {
      stat: "100+",
      label: "Years since Dr. Mikao Usui developed Reiki healing system",
      icon: Star,
    },
    {
      stat: "94%",
      label: "Of clients experience deep relaxation during Reiki sessions",
      icon: Heart,
    },
    {
      stat: "7 Chakras",
      label: "Energy centers balanced and harmonized through Reiki",
      icon: Sparkles,
    },
    {
      stat: "89%",
      label: "Report improved energy levels after regular Reiki practice",
      icon: TrendingUp,
    },
  ];
  ...
  const processSteps = [
    {
      ...
      description: "Discuss your health concerns, goals, and what you hope to achieve through Reiki healing energy work.",
    },
    {
      step: "02",
      title: "Energy Assessment",
      description: "Practitioner assesses your energy field and chakras to identify areas needing attention and balance.",
    },
    {
      step: "03",
      title: "Healing Session",
      description: "Receive Reiki energy through hands-on or distance methods while you relax completely and allow healing to occur.",
    },
    {
      step: "04",
      title: "Integration & Aftercare",
      description: "Discuss experiences, receive guidance for continued healing, and schedule follow-up sessions if desired.",
    },
  ];
      ...
      <div className="bg-gradient-to-b from-muted/30 via-background to-background">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white">
                  Reiki Energy
                  <span className="block mt-2 bg-gradient-to-r from-secondary to-tertiary bg-clip-text text-transparent">Healing</span>
                </h1>

                <p className="text-xl text-white/90 mb-8 leading-relaxed">
                  Experience the gentle yet powerful healing of universal life force energy. Restore balance, reduce stress, and support your body's natural healing through the ancient practice of Reiki.
                </p>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-2xl text-gradient">94%</p>
                      <p className="text-sm text-muted-foreground">Deep Relaxation</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                The Power of <span className="text-gradient">Universal Energy</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Reiki harnesses the healing power of universal life force energy to restore balance and promote wellbeing.
              </p>
            </motion.div>
        ...
        <section className="py-20 px-6">
          <div className="container mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Experience profound healing as universal life force energy flows through you, restoring balance and vitality
              </p>
            </motion.div>
        ...
        <section id="offerings" className="py-20 px-6 bg-gradient-soft">
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Reiki <span className="text-gradient">Services</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Choose the healing approach that best supports your physical, emotional, and spiritual wellbeing
              </p>
            </motion.div>
        ...
        <section className="py-20 px-6">
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Your Healing <span className="text-gradient">Journey</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                A gentle pathway from energy assessment to restored balance and vitality
              </p>
            </motion.div>
          ...
          <div className="container mx-auto max-w-4xl text-center relative z-10">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Ready to Experience Healing Energy?
              </h2>
              <p className="text-xl mb-8 text-white/90 leading-relaxed">
                Let universal life force energy restore your balance and vitality. Book your Reiki session today.
              </p>
